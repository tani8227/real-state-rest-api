...
agentRouter.patch("/update-configuration-details", checkAuthentication, agentController.addConfiguration);
agentRouter.patch("/update-uploadMedia-details", checkAuthentication, agentController.addUploadMedia);
agentRouter.patch("/update-document-details", checkAuthentication, agentController.addDocument);
